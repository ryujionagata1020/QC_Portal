...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "cdn.jsdelivr.net", "https://www.googletagmanager.com", "https://static.cloudflareinsights.com", "https://pagead2.googlesyndication.com"],
...
app.use((req, res, next) => {
  ...
  res.locals.canonicalUrl = 'https://qc-portals.com' + req.path;
  next();
});
